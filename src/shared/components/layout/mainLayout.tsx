    ...
    <section className="flex h-screen">
      {isBigScreen ? (
        <SplitPane split="vertical" sizes={sizes} onChange={setSizes} sashRender={sashRender}>
          <Pane minSize={180} maxSize="30%" className="hidden lg:flex">
            <section className="flex flex-col w-full h-screen max-h-screen bg-[#030303] text-white">
              <Link href="/">
          ...
          <Pane>
            <section className="relative flex-1 h-screen max-h-screen bg-gradient-to-br from-[#1f1f1f] to-[#1f1e1e]">
