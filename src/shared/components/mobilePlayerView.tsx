...
export function MobilePlayerView() {
  ...
  return (
    <>
      <section className="fixed bottom-0 flex h-[10vh] w-full bg-gradient-to-br from-[#121212] to-[#181818] items-center justify-center px-8">
        ...
        <section className="flex w-full flex-col items-center justify-center">
          ...
          <div className="flex gap-4 w-full items-center">
            <span className="text-white text-xs flex">{formatTime(currentTime)}</span>
            <input
              type="range"
              min={0}
              max={duration}
            ...
            />
            <span className="text-white text-xs flex">{formatTime(duration)}</span>
          </div>
        </section>
      </section>
