...
export function AlbumCard() {
  return (
    <div className="group relative flex flex-col gap-2 w-52 h-72 bg-gradient-to-br from-[#121212] to-[#181818] rounded-md shadow-md p-4 transform hover:scale-105 hover:shadow-lg transition-all duration-200">
